                            ...
                            <div className="grid grid-cols-2 gap-3 pt-2">
                               {(q.options || []).map((opt: string, oIndex: number) => (
                                 <div key={oIndex} className="flex items-center gap-2">
                                   ...
                                   <input type="text" placeholder={`Option ${oIndex + 1}`} className="flex-1 text-sm bg-white border border-slate-200 rounded-md px-3 py-1.5 focus:ring-2 focus:ring-blue-500 outline-none" value={opt} onChange={e => {
                                      const qs = [...formData.questions];
